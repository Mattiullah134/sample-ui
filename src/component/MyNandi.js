        ...
        <div className='text-white w-[80%] flex flex-col  max-sm:items-center items-start'>
            <div className="mynandiBanner max-md:w-[100%] max-sm:w-[100%] max-md:ml-auto max-md:  border-slate-50 bg-gradient-to-br from-purple-900 to-black w-[100%]  h-96 rounded-lg p-5 max-sm:h-auto ml-0">
                <div className="flex flex-col h-full justify-between items-center">
                    ...
                    <button type="button" className="py-2.5 bg-white text-black mt-3  px-5 mr-2 mb-2 text-sm font-medium focus:outline-none rounded-full border border-gray-200 hover:bg-gray-100 hover:bg-transparent focus:z-10 focus:ring-4 focus:ring-gray-200  focus:ring-gray-700   text-gray-400  border-gray-600  hover:text-white  hover:bg-gray-700">REEDEM REWARDS</button>
                </div>
            </div>
            ...
            <div className='nandiContainer w-[100%] flex gap-16 max-sm:flex-col  max-sm:gap-10 justify-start flex-wrap items-center overflow-x-scroll '>
                ...
                <div className="max-w-sm p-6  max-md:w-[80%] w-[28%]   rounded-xl shadow bg-[#23262f] mt-10 border-gray-500 flex flex-col text-center items-center justify-center">
                    <a href="#">
                        <h5 className="mb-2 text-center text-m font-bold tracking-tight  text-white  m-auto">Sign up to <div>Nandi</div></h5>
                    </a>
                    <button type="button" className="text-white bg-[#2563eb] hover:bg-blue-800  font-medium rounded-lg  px-10 py-2.5  mb-2  hover:bg-blue-700 focus:outline-none  mt-5 text-2xl">20 <div className='text-xs font-semibold'>Pints Won</div></button>
                ...
                <div className="max-w-sm p-6   max-md:w-[80%] w-[28%]  text-m rounded-xl shadow bg-[#23262f] mt-10 border-gray-500 flex flex-col text-center items-center justify-center">
                    <a href="#">
                        <h5 className="mb-2 text-center text-l font-bold tracking-tight text-gray-900  text-white  m-auto">Complete <div>Your Profile</div></h5>
                    </a>

                    <button type="button" className="text-white bg-black font-medium rounded-lg text-2xl px-10 py-2.5  mb-2  focus:outline-none  focus:ring-blue-800 mt-5">20 <div className='text-xs font-semibold'>Pints Won</div></button>
                ...
                <div className=" p-6  max-md:w-[80%] w-[28%]   rounded-xl shadow bg-[#23262f] mt-10 border-gray-500 flex flex-col text-center items-center justify-center">
                    <a href="#">
                        <h5 className="mb-2 text-center text-l font-bold tracking-tight text-gray-900  text-white  m-auto">Sign up to <div>Nandi</div></h5>
                    </a>
            ...
            <div className='w-[100%] '>
                ...
                <div className='flex w-[100%]  gap-16 max-sm:flex-col max-md:flex-col max-sm:gap-10  flex-wrap justify-start items-center'>
                    <div className="max-w-sm p-6   w-[28%] max-md:w-[80%]   rounded-xl shadow bg-[#23262f] mt-10 border-gray-500 flex flex-col text-center items-center justify-center">
                        <a href="#">
                            <h5 className="mb-2 text-center text-m font-bold tracking-tight text-white  border-2  w-20 h-20 flex items-center justify-center rounded-full  m-auto">1</h5>
                        </a>
            ...
            <div className=''>
                ...
                <a href="#" className="flex flex-col items-center gap-20 border border-gray-200 rounded-lg shadow md:flex-row   border-gray-700 bg-[#23262f] ">
                    ...
                    <div className="flex  flex-col justify-between  text-center  max-sm:w-[80%]  leading-normal">
                        ...
                        <button type="button" className="text-white bg-[#1647fb] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 w-32 text-center font-medium rounded-lg mx-auto px-5 py-2.5  mb-2 hover:bg-blue-600 focus:outline-none focus:ring-blue-800 mt-5 text-2xl">20 <div className='text-xs font-semibold'>Pints Won</div></button>
                    </div>
                </a>
