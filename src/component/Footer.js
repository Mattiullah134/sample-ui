...
const Footer = () => {
    return (
        ...
        <footer className="relative mt-40 max-sm:text-center border-t border-gray-200  border-gray-700">
            <div className="mx-auto w-full max-sm:text-center  max-w-screen-xl p-4 py-6 lg:py-8 sticky bottom-0">
                <div className="md:flex max-md:items-center max-sm:text-center max-md:flex-col md:justify-between ">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 max-sm:grid-cols-1 max-sm:text-center ">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold  uppercase text-white">Nandi.</h2>
                            <ul className="text-gray-600  text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://flowbite.com/" className="hover:underline">Learn More</a>
                                </li>
                                <li className="mb-4">
                                    <a href="https://flowbite.com/" className="hover:underline">Carrers</a>
                                </li>
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase  text-white">Socials</h2>
                            <ul className="text-gray-600  text-gray-400 font-medium">
                                <li className="mb-4">
                                ...
                                <li>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                            <svg aria-hidden="true" className="w-5 h-5 text-gray-500  text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                                        </div>
                                        <input type="search" id="search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500  bg-gray-700  border-gray-600  placeholder-gray-400  text-white  focus:ring-blue-500  focus:border-blue-500" placeholder="Search" required />
                                        <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-3 py-2  bg-blue-600  hover:bg-blue-700  focus:ring-blue-800"><i className="fa-solid fa-arrow-right-long"></i></button>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="flex max-md:flex-col items-center justify-between">
                    <span className="text-sm max-md:mb-5 text-gray-500 sm:text-center  text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Flowbite™</a>. All Rights Reserved.
                    </span>
